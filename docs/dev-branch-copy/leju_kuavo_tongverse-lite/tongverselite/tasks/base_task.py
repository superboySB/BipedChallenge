...
import tongverselite as tv
from tongverselite.objects.object import Object
from tongverselite.utils import convert_data_format, is_isaac_sim_2023
...
class BaseTask:
    ...
    def sample_initial_pose(
        ...
        backend = tv.sim.instance().backend
        device = tv.sim.instance().device
        backend_utils = tv.sim.instance().backend_utils
    ...
    def _create_d6_joint(
        ...
        d6joint = UsdPhysics.Joint.Define(tv.sim.stage, joint_path)
    ...
    def _create_fixed_joint(self, body_name: str, obj: Object) -> None:
        joint_path = "/World/tmp"
        fixed_joint = UsdPhysics.FixedJoint.Define(tv.sim.stage, joint_path)
