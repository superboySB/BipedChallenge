...
from tongverselite.tasks.task_two import TaskTwo
from tongverselite.utils import set_global_seed
...
class Env:
    ...
    def __init__(self, task_num: int = 1, seed: int = None) -> None:
        ...
        tv.sim.set_simulation_dt(physics_dt=0.001, rendering_dt=0.001)
    ...
    def step(self, action: dict) -> Tuple[bool, bool, Dict]:
        ...
        self._sim_time += tv.sim.get_physics_dt()
        return done, success, obs
