...
from tongverselite.objects.articulated_object import ArticulatedObject
from tongverselite.objects.object import Object

SCENE_USD_PATH = str(tv.ROOT_PATH.parent / "data" / "scene" / "main.usd")
SCENE_METADATA_PATH = str(tv.ROOT_PATH.parent / "data" / "scene" / "obj_simu_cfg.json")
